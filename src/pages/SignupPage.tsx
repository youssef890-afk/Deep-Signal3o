...
export default function SignupPage() {
  ...
  /*
   * Countdown ديال إعادة إرسال OTP
   */
  useEffect(() => {
  ...
  const handleVerifyOtp = async (
    ...
    /*
     * هنا فقط نقولو verified.
     *
     * ما كاين حتى Fake verification.
     */
    setVerified(true);
    setError(null);
    setSuccessMessage(
  ...
  if (verificationMode) {
    return (
      ...
      >
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] max-w-[400px] aspect-square rounded-full border border-pink-400/[0.08] animate-pulse pointer-events-none" />
