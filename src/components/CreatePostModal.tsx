...
export const CreatePostModal: React.FC<CreatePostModalProps> = ({
  ...
  const handleUploadAndPost = async () => {
    ...
    try {
      ...
      const finalContent = quranTrack
        ? `${content.trim()}\n\n📖 خلفية قرآنية: ${quranTrack.trim()}`
        : content.trim();
          ...
          <div className="space-y-4">
            ...
            {postType === 'image' && (
              <div className="bg-neutral-950 border border-dashed border-neutral-700 p-4 rounded-xl text-center">
                ...
                <label
                  htmlFor="image-input"
                  className="cursor-pointer text-sm text-neutral-300 flex flex-col items-center"
                >
            ...
            >
              ...
              <span>
                {loading ? 'جاري الضغط والنشر...' : 'نشر الآن'}
              </span>
            </button>
          </div>
        )}
